  ...
  return (
    <div className="col">
      <div className="card card-new mb-4 shadow">
        ...
        <div
          className="card-footer btn-center d-md-flex align-items-center"
          style={{ position: "absolute", bottom: "0", width: "100%" }}
        >
          <span className="flex-grow-1 d-flex margin-left align-items-center">
            {" "}
            <Rating
              style={{ width: "100px" }}
              value={rating}
              readOnly
            ></Rating>{" "}
            <span className="mt-1 ms-1">{rating}</span>
          </span>
